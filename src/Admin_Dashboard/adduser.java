        ...
        if( ename.getText().trim().isEmpty() && eid.getText().trim().isEmpty() && epass.getText().trim().isEmpty() &&
            ...
            try{                 
                ...
                if (p == 0) {
                    ...
                    String inserttask =("The new user (user ID)"+eid.getText()+" are Insert by this Admin :- "+adminname.getText());
                ...
                try{
                    ...
                    if (p == 0) {                         
                        ...
                        if(status > 0) { 
                            ...
                            String inserttask =("The User (user ID)"+eid.getText()+" are Updated by this Admin :- "+adminname.getText());
                            String userinsert = "insert into history (sno, User_Id, User_Name, Date_Time, User_Task) values(null,'"+admibid.getText()+"','"+adminname.getText()+"','"+timeshow.getText()+"','"+inserttask+"')";
                            pst = conn.prepareStatement(userinsert);
                            pst.executeUpdate(); 
            ...
            try{
                ...
                if (p == 0) {
                    ...
                    if(status > 0){
                        ...
                        String inserttask =("The User (user ID)"+eid.getText()+" are Deleted by this Admin :- "+adminname.getText());
                        String userinsert = "insert into history (sno, User_Id, User_Name, Date_Time, User_Task) values(null,'"+admibid.getText()+"','"+adminname.getText()+"','"+timeshow.getText()+"','"+inserttask+"')";
                        pst = conn.prepareStatement(userinsert);
                        pst.executeUpdate(); 
