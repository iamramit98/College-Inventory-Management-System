...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        Suppliername.setFont(new java.awt.Font("Baskerville Old Face", 0, 16)); // NOI18N
        ...
        Supplierid.setFont(new java.awt.Font("Bookman Old Style", 0, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(DateOfPurchase, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(paymentmode, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        all_table.setBackground(new java.awt.Color(255, 255, 153));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            + "VALUES (null,'"+Invoiceno.getText()+"','"+Supplierid.getText()+"','"+Suppliername.getSelectedItem()+"','"+GSTno.getText()+"','"+idop+"',"+tot_qty.getText()+","+tot_amt.getText()+","+tot_cgst_per.getText()+","+tot_cgst_amt.getText()+","+tot_sgst_per.getText()+","+tot_sgst_amt.getText()+","+tot_tax_p.getText()+","+tot_tax_a.getText()+","+tot_discount_per.getText()+","+tot_discount_amt.getText()+","+bill_tot.getText()+",'"+paymentmode.getSelectedItem()+"','"+Status+"')";           
            ...
            for (int i = 0; i < rc; i++) {
                ...
                if(gen=="Computer"){
                    ...
                    + "VALUES (null,'"+Invoiceno.getText()+"','"+Supplierid.getText()+"','"+Suppliername.getSelectedItem()+"','"+GSTno.getText()+"','"+idop+"','"+idesc+"','"+idesctype+"','"+ihsn+"',"+iqty+","+irate+","+iamount+","+icgst+","+icgstamt+","+isgst+","+isgstamt+","+idisc+","+idiscamt+","+ifinalamt+",'"+paymentmode.getSelectedItem()+"','"+iwarranty+"','"+iconfigration+"')";
                    ...
                    for(int cl=1;cl<=Integer.parseInt(iqty);cl++){
                        ...
                        rs.last();{
                            ...
                            + "VALUES (null,'"+id+"','"+Invoiceno.getText()+"','"+Supplierid.getText()+"','"+Suppliername.getSelectedItem()+"','"+GSTno.getText()+"','"+idesc+"','"+idesctype+"','"+idop+"','"+iwarranty+"','"+iconfigration+"');";
            ...
            String inserttask =("The record (Invoice No)"+Invoiceno.getText()+" are inserted by this Admin :- "+adminname.getText());
                String userdelete = "insert into history (sno, User_Id, User_Name, Date_Time, User_Task) values(null,'"+admibid.getText()+"','"+adminname.getText()+"','"+timeshow.getText()+"','"+inserttask+"')";
